...
| --------- | ---------------------- | ----------------------- | ----------------------- | ----------------------------------------------------- |
| Agent LLM | Gemini 2.5 Flash-Lite  | **$0.10**               | **$0.40**               | 가장 저렴한 2.5 계열 모델. 고성능 필요 최소화 시 적합 |
| Agent LLM | GPT‑4o mini            | ~$0.15                  | ~$0.60                  | OpenAI 저비용 계열. 텍스트 기반 사용 시 유리          |
| Agent LLM | Gemini 2.5 Flash       | ~$0.30                  | ~$2.50                  | 성능은 높지만 비용도 증가됨                           |
| Embedding | text-embedding-3-small | **$0.02**               | ~$0 (사실상 무료)       | 비용 매우 저렴. 대량 임베딩 시 유리                   |
